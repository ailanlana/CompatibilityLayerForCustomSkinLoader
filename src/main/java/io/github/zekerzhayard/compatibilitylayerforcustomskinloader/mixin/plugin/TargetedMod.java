...
public enum TargetedMod {
    ...
    TF("The Twilight Forest", "TwilightForest", true, "TwilightForest"),
    MMMLib("MMMLib", "littleMaidMobX", true, "MMMLib"),
    MOBENDS("Mo' Bends", "MoBends", true, "mobends"),
    AW("Armourer's Workshop", "Armourers-Workshop", true, "armourersWorkshop"),
    ;
